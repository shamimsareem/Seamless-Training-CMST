...
class LowRank(nn.Module):
    def __init__(self, embed_dim, att_type, att_heads, att_mid_dim, att_mid_drop):
        ...
        self.norm_k = nn.GroupNorm(self.num_heads, embed_dim)
        self.norm_v2 = nn.GroupNorm(self.num_heads, embed_dim)
    ...
    def forward(self, query, key, mask, value1, value2, precompute=False):
        ...
        if precompute == False:
            ...
            k = self.norm_k(F.relu(self.in_proj_k(key)))
            v2 = self.norm_v2(F.relu(self.in_proj_v2(value2)))
    ...
    def forward2(self, query, key, mask, value1, value2, precompute=False):
        ...
        alue1 = value1.view(-1, value1.size()[-1])
